...
public class WargaController {
	...
	public List<AnggotaKeluarga> getById(@PathVariable String id_kk) {
	...
	@DeleteMapping("/deleteByKaka/{id_kk}")
	public List<AnggotaKeluarga> deleteByKaka(@PathVariable String id_kk) {
		return wargaService.deleteByKaka(id_kk);
	}
